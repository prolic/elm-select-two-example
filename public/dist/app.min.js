...
var $MadonnaMat$elm_select_two_example$Main$init = function (flags) {
	return _Utils_Tuple2(
		{modalVisibility: $rundis$elm_bootstrap$Bootstrap$Modal$hidden, selectTwo: $elm$core$Maybe$Nothing, test3: _List_Nil},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $MadonnaMat$elm_select_two_example$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $MadonnaMat$elm_select_two_example$Main$SelectTwo = function (a) {
	return {$: 'SelectTwo', a: a};
};
var $MadonnaMat$elm_select_two_example$Main$ShowModal = {$: 'ShowModal'};
...
var $MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoSelected = function (a) {
	return {$: 'SelectTwoSelected', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2Close = function (sender) {
	return $elm$html$Html$Events$onClick(
		sender(
			$MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoSelected($elm$core$Maybe$Nothing)));
};
var $elm$html$Html$Attributes$rel = _VirtualDom_attribute('rel');
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2Css = A3(
	$elm$html$Html$node,
	'link',
	_List_fromArray(
		[
			$elm$html$Html$Attributes$rel('stylesheet'),
			$elm$html$Html$Attributes$href('//cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css')
		]),
	_List_Nil);
var $MadonnaMat$elm_select_two_example$Main$CloseModal = {$: 'CloseModal'};
var $MadonnaMat$elm_select_two_example$Main$Test3 = function (a) {
	return {$: 'Test3', a: a};
};
var $MadonnaMat$elm_select_two_example$Main$Test3Clear = function (a) {
	return {$: 'Test3Clear', a: a};
};
...
var $MadonnaMat$elm_select_two_example$Main$customHtml = function (_v0) {
	var msg = _v0.a;
	var txt = _v0.b;
	var sel = _v0.c;
	if ((msg.$ === 'Just') && (msg.a.$ === 'Test3')) {
		return $elm$core$Maybe$Just(
			A2(
				$elm$html$Html$span,
				_List_fromArray(
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$tuple3First = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return a;
};
var $MadonnaMat$elm_select_two$SelectTwo$defaultsFromList = F2(
			...
			function (l) {
				return A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (a) {
							return A2($elm$core$List$member, a, defaults);
						},
						$MadonnaMat$elm_select_two$SelectTwo$Private$tuple3First(l)));
			},
			A2(
				$elm$core$List$concatMap,
				function (_v0) {
...
var $MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoTrigger = function (a) {
	return {$: 'SelectTwoTrigger', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Private$buildDropdown = F7(
	function (id_, defaults, list, showSearch, ajax, delay, noResultsMessage) {
		return {ajax: ajax, defaults: defaults, delay: delay, id_: id_, list: list, noResultsMessage: noResultsMessage, showSearch: showSearch, width: 0, x: 0, y: 0};
	});
var $MadonnaMat$elm_select_two$SelectTwo$Private$location = F8(
	function (id_, sender, defaults, list, showSearch, noResultsMessage, ajax, delay) {
		return A2(
			$elm$json$Json$Decode$map,
			function (msg) {
			...
			A2(
				$elm$json$Json$Decode$map,
				A2($elm$core$Basics$composeR, $MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoTrigger, sender),
				$elm$json$Json$Decode$succeed(
					A7($MadonnaMat$elm_select_two$SelectTwo$Private$buildDropdown, id_, defaults, list, showSearch, ajax, delay, noResultsMessage))));
	});
var $MadonnaMat$elm_select_two$SelectTwo$Types$SetSelectTwoSearch = function (a) {
	return {$: 'SetSelectTwoSearch', a: a};
};
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $MadonnaMat$elm_select_two$SelectTwo$Html$preventAndStop = function (msg) {
	return $elm$json$Json$Decode$succeed(
		{message: msg, preventDefault: true, stopPropagation: true});
};
var $MadonnaMat$elm_select_two$SelectTwo$Html$multiSelectSpan = F9(
	function (sender, id_, defaults, list, clearMsg, closeOnClear, disabled, placeholder, ajax) {
		var theList = ajax ? _List_fromArray(
			[
				_Utils_Tuple2('', defaults)
			]) : list;
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('select2-selection select2-selection--multiple')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('select2-selection__rendered')
						]),
					_Utils_ap(
						A2(
							$elm$core$List$map,
							function (_v0) {
								...
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('select2-selection__choice')
										]),
									_List_fromArray(
										[
											function () {
											if (clearMsg.$ === 'Just') {
												var clrMsg = clearMsg.a;
												return closeOnClear ? A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('select2-selection__choice__remove'),
															A2(
															$elm$html$Html$Events$custom,
															'click',
															$MadonnaMat$elm_select_two$SelectTwo$Html$preventAndStop(
																sender(
																	$MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoSelected(
																		$elm$core$Maybe$Just(
																			clrMsg(msg))))))
														]),
													_List_fromArray(
							...
							A2(
								...
								A2($elm$core$List$concatMap, $elm$core$Tuple$second, theList))),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$li,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('select2-search select2-search--inline')
									]),
								_List_fromArray(
									[
										(!disabled) ? A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('select2-search__field'),
												$elm$html$Html$Events$onInput(
												A2($elm$core$Basics$composeR, $MadonnaMat$elm_select_two$SelectTwo$Types$SetSelectTwoSearch, sender)),
												$elm$html$Html$Attributes$id(id_ + '--search'),
												$elm$html$Html$Attributes$placeholder(
												($elm$core$List$length(defaults) > 0) ? '' : placeholder)
											]),
...
var $MadonnaMat$elm_select_two$SelectTwo$Html$singleSelectSpan = F5(
	function (sender, _default, clearMsg, closeOnClear, placeholder) {
		var _v0 = A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple3($elm$core$Maybe$Nothing, '', false),
			_default);
		var defaultMsg = _v0.a;
		var defaultText = _v0.b;
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('select2-selection select2-selection--single')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							if (defaultText === '') {
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('select2-selection__placeholder')
										]),
									_List_fromArray(
										[
								...
								if (clearMsg.$ === 'Just') {
									...
									return closeOnClear ? A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('select2-selection__clear'),
												A2(
												$elm$html$Html$Events$custom,
												'click',
												$MadonnaMat$elm_select_two$SelectTwo$Html$preventAndStop(
							...
							$elm$html$Html$text(defaultText)
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('select2-selection__arrow')
						]),
					_List_fromArray(
						[
...
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2 = F2(
	function (sender, _v0) {
		var defaults = _v0.defaults;
		var list = _v0.list;
		var clearMsg = _v0.clearMsg;
		var showSearch = _v0.showSearch;
		var width = _v0.width;
		var placeholder = _v0.placeholder;
		var id_ = _v0.id_;
		var disabled = _v0.disabled;
		var multiSelect = _v0.multiSelect;
		var noResultsMessage = _v0.noResultsMessage;
		var ajax = _v0.ajax;
		var delay = _v0.delay;
		var closeOnClear = _v0.closeOnClear;
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('select2 elm-select2 select2-container select2-container--default select2-container--below select2-container--focus', true),
							_Utils_Tuple2('select2-container--disabled', disabled)
						])),
					...
					$elm$html$Html$Events$custom,
					'click',
					A8($MadonnaMat$elm_select_two$SelectTwo$Private$location, id_, sender, defaults, list, showSearch && (!multiSelect), noResultsMessage, ajax, delay)) : A2($elm$html$Html$Attributes$attribute, 'data-blank', '')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							multiSelect ? A9($MadonnaMat$elm_select_two$SelectTwo$Html$multiSelectSpan, sender, id_, defaults, list, clearMsg, closeOnClear, disabled, placeholder, ajax) : A5(
							$MadonnaMat$elm_select_two$SelectTwo$Html$singleSelectSpan,
							sender,
							$elm$core$List$head(defaults),
							clearMsg,
							closeOnClear,
							placeholder)
						]))
...
var $MadonnaMat$elm_select_two$SelectTwo$Types$ResultScroll = function (a) {
	return {$: 'ResultScroll', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Types$STNull = {$: 'STNull'};
var $elm$core$String$toLower = _String_toLower;
var $MadonnaMat$elm_select_two$SelectTwo$Private$filterList = F2(
	function (filter, _v0) {
		var text = _v0.b;
		return A2(
			$elm$core$Maybe$withDefault,
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$filterGroup = F2(
	function (filter, list) {
		return A2(
			$elm$core$Tuple$mapSecond,
			$elm$core$List$filter(
				$MadonnaMat$elm_select_two$SelectTwo$Private$filterList(filter)),
			list);
	});
var $MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoHovered = function (a) {
	return {$: 'SelectTwoHovered', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Private$boolToString = function (a) {
	if (a) {
		return 'True';
	} else {
		return 'False';
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Second = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return b;
};
var $MadonnaMat$elm_select_two$SelectTwo$Html$runCustomHtml = F2(
	function (customHtml, option) {
		return A2(
			$elm$core$Maybe$withDefault,
			$elm$html$Html$text(
				$MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Second(option)),
			A2(
				$elm$core$Maybe$andThen,
				function (ch) {
					return ch(option);
...
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2ListItem = F5(
				...
				_List_fromArray(
					[
						...
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('select2-results__option', true),
									_Utils_Tuple2(
									'select2-results__option--highlighted',
									_Utils_eq(msg, hovered))
								])),
							$elm$html$Html$Events$onMouseOver(
							sender(
								$MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoHovered(msg)))
						]),
						enabled ? _List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							sender(
								$MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoSelected(msg))),
							A2(
							$elm$html$Html$Attributes$attribute,
							'aria-selected',
							$elm$core$String$toLower(
								$MadonnaMat$elm_select_two$SelectTwo$Private$boolToString(
									A2($elm$core$List$member, option, defaults))))
						]) : _List_fromArray(
						[
							A2(
							$elm$html$Html$Attributes$attribute,
							'aria-disabled',
							$elm$core$String$toLower(
								$MadonnaMat$elm_select_two$SelectTwo$Private$boolToString(!enabled)))
						])
					])),
			_List_fromArray(
				[
					A2($MadonnaMat$elm_select_two$SelectTwo$Html$runCustomHtml, customHtml, option)
				]));
	});
var $elm$html$Html$strong = _VirtualDom_node('strong');
var $MadonnaMat$elm_select_two$SelectTwo$Private$uniqueHelp = F4(
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$uniqueBy = F2(
	function (f, list) {
		return A4($MadonnaMat$elm_select_two$SelectTwo$Private$uniqueHelp, f, _List_Nil, list, _List_Nil);
	});
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2ListGroup = F5(
	function (sender, defaults, hovered, customHtml, _v0) {
		var label = _v0.a;
		var list = _v0.b;
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('select2-results__option')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('select2-results__group')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(label)
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('select2-results__options select2-results__options--nested')
						]),
					A2(
						$elm$core$List$map,
						A4($MadonnaMat$elm_select_two$SelectTwo$Html$select2ListItem, sender, defaults, hovered, customHtml),
						A2($MadonnaMat$elm_select_two$SelectTwo$Private$uniqueBy, $elm$core$Basics$identity, list)))
				]));
	});
var $MadonnaMat$elm_select_two$SelectTwo$Html$listOrGroup = F6(
	function (sender, defaults, list, hovered, search, customHtml) {
		return (($elm$core$List$length(list) === 1) && (A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$first,
				$elm$core$List$head(list))) === '')) ? A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
				$elm$core$Maybe$map,
				...
				A2(
					$elm$core$Maybe$map,
					$MadonnaMat$elm_select_two$SelectTwo$Private$uniqueBy($elm$core$Basics$identity),
					A2(
						$elm$core$Maybe$map,
						$elm$core$List$filter(
							$MadonnaMat$elm_select_two$SelectTwo$Private$filterList(search)),
						A2(
							$elm$core$Maybe$map,
							$elm$core$Tuple$second,
							$elm$core$List$head(list)))))) : A2(
			$elm$core$List$map,
			A4($MadonnaMat$elm_select_two$SelectTwo$Html$select2ListGroup, sender, defaults, hovered, customHtml),
			A2(
				$elm$core$List$map,
				$MadonnaMat$elm_select_two$SelectTwo$Private$filterGroup(search),
				list));
	});
var $MadonnaMat$elm_select_two$SelectTwo$Html$noResultsFound = function (noResults) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('select2-results__option', true),
						_Utils_Tuple2('select2-results__message', true)
					]))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
				A2($elm$core$Maybe$withDefault, 'No Results Found', noResults))
			]));
};
var $MadonnaMat$elm_select_two$SelectTwo$Private$px = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$fromFloat,
	function (a) {
		return a + 'px';
	});
var $MadonnaMat$elm_select_two$SelectTwo$Types$ScrollInfo = F2(
	function (scrollHeight, scrollTop) {
		return {scrollHeight: scrollHeight, scrollTop: scrollTop};
	});
var $MadonnaMat$elm_select_two$SelectTwo$Html$scrollPosition = function (wrapper) {
	return A2(
		$elm$json$Json$Decode$map,
		wrapper,
		A3(
			$elm$json$Json$Decode$map2,
			$MadonnaMat$elm_select_two$SelectTwo$Types$ScrollInfo,
			A2(
				$elm$json$Json$Decode$at,
				_List_fromArray(
					['target', 'scrollHeight']),
...
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2DropdownDraw = F7(
	function (sender, _v0, hovered, search, ajaxList, ajaxParams, customHtml) {
		var id_ = _v0.id_;
		var defaults = _v0.defaults;
		var list = _v0.list;
		var showSearch = _v0.showSearch;
		...
		var theList = ajax ? ((A2(
			...
			A2(
				...
				ajaxParams)) && $elm$core$List$isEmpty(ajaxList)) ? _List_fromArray(
			[
				_Utils_Tuple2(
				'',
				_List_fromArray(
					[
						_Utils_Tuple3($elm$core$Maybe$Nothing, 'Searching', false)
					]))
			]) : ajaxList) : list;
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('elm-select2 select2-container select2-container--default select2-container--open'),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
					A2(
					$elm$html$Html$Attributes$style,
					'left',
					$MadonnaMat$elm_select_two$SelectTwo$Private$px(x)),
					A2(
					$elm$html$Html$Attributes$style,
					'top',
					$MadonnaMat$elm_select_two$SelectTwo$Private$px(y)),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$MadonnaMat$elm_select_two$SelectTwo$Private$px(width))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('select2-dropdown select2-dropdown--below')
						]),
					_List_fromArray(
						[
							showSearch ? A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('select2-search select2-search--dropdown')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											'click',
											$MadonnaMat$elm_select_two$SelectTwo$Html$preventAndStop(
												sender($MadonnaMat$elm_select_two$SelectTwo$Types$STNull)))
										]),
									_List_Nil)
								])) : $elm$html$Html$text(''),
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('select2-results')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('select2-results__options'),
											A2(
											$elm$html$Html$Events$on,
											'scroll',
											$MadonnaMat$elm_select_two$SelectTwo$Html$scrollPosition(
												A2($elm$core$Basics$composeR, $MadonnaMat$elm_select_two$SelectTwo$Types$ResultScroll, sender)))
										]),
									(ajax && (_Utils_eq(
										theList,
										_List_fromArray(
											...
											])) || $elm$core$List$isEmpty(theList))) ? _List_fromArray(
										[
											$MadonnaMat$elm_select_two$SelectTwo$Html$noResultsFound(noResultsMessage)
										]) : A6($MadonnaMat$elm_select_two$SelectTwo$Html$listOrGroup, sender, defaults, theList, hovered, search, customHtml))
								]))
						]))
				]));
	});
var $MadonnaMat$elm_select_two$SelectTwo$Html$select2Dropdown = F3(
	function (sender, customHtml, model) {
		var _v0 = model.selectTwo;
		if (_v0.$ === 'Just') {
			var dropdown = _v0.a.dropdown;
			var hovered = _v0.a.hovered;
			var search = _v0.a.search;
			var list = _v0.a.list;
			var ajaxParams = _v0.a.ajaxParams;
			return A7($MadonnaMat$elm_select_two$SelectTwo$Html$select2DropdownDraw, sender, dropdown, hovered, search, list, ajaxParams, customHtml);
		} else {
			return $elm$html$Html$text('');
		}
	});
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$groupWhile = F2(
	function (eq, xs_) {
		if (!xs_.b) {
			return _List_Nil;
		} else {
			...
			var xs = xs_.b;
			var _v1 = A2(
				$elm_community$list_extra$List$Extra$span,
				eq(x),
				xs);
			var ys = _v1.a;
			var zs = _v1.b;
			return A2(
				...
				A2($MadonnaMat$elm_select_two$SelectTwo$Private$groupWhile, eq, zs));
		}
	});
var $MadonnaMat$elm_select_two$SelectTwo$selectOption = F2(
	function (msg, _v0) {
		var val = _v0.a;
		var txt = _v0.b;
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Init = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return _Utils_Tuple2(a, b);
};
var $MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Third = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var c = _v0.c;
	return c;
};
var $MadonnaMat$elm_select_two$SelectTwo$selectGroup = F2(
	function (msg, list) {
		return _Utils_Tuple2(
			A2(
				$elm$core$Maybe$withDefault,
				...
				A2(
					$elm$core$Maybe$map,
					$MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Third,
					$elm$core$List$head(list))),
			A2(
				$elm$core$List$map,
				A2(
					$elm$core$Basics$composeR,
					$MadonnaMat$elm_select_two$SelectTwo$Private$tuple3Init,
					$MadonnaMat$elm_select_two$SelectTwo$selectOption(msg)),
				list));
	});
var $MadonnaMat$elm_select_two$SelectTwo$basicGroupSelectOptions = F2(
	function (msg, list) {
		return A2(
			$elm$core$List$map,
			$MadonnaMat$elm_select_two$SelectTwo$selectGroup(msg),
			A2(
				$MadonnaMat$elm_select_two$SelectTwo$Private$groupWhile,
				F2(
					function (_v0, _v1) {
						var a = _v0.c;
						var b = _v1.c;
...
var $MadonnaMat$elm_select_two_example$Main$testList3 = function (msg) {
	return A2(
		$MadonnaMat$elm_select_two$SelectTwo$basicGroupSelectOptions,
		msg,
		_List_fromArray(
			[
				_Utils_Tuple3(
...
var $MadonnaMat$elm_select_two_example$Main$viewModal = function (model) {
	return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($MadonnaMat$elm_select_two_example$Main$CloseModal)
								]))
						]),
					_List_fromArray(
						[
			...
			A3(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('p2')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Single Group, Multi-Select, Custom Rows, Position Absolute, Close On Clear'),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										A2(
										$MadonnaMat$elm_select_two$SelectTwo$Html$select2,
										$MadonnaMat$elm_select_two_example$Main$SelectTwo,
										{
											ajax: false,
											clearMsg: $elm$core$Maybe$Just($MadonnaMat$elm_select_two_example$Main$Test3Clear),
											closeOnClear: true,
											defaults: A2(
												$MadonnaMat$elm_select_two$SelectTwo$defaultsFromList,
												A2($elm$core$List$map, $MadonnaMat$elm_select_two_example$Main$Test3, model.test3),
												$MadonnaMat$elm_select_two_example$Main$testList3($MadonnaMat$elm_select_two_example$Main$Test3)),
											delay: 0,
											disabled: false,
											id_: 'test-3',
											list: $MadonnaMat$elm_select_two_example$Main$testList3($MadonnaMat$elm_select_two_example$Main$Test3),
											multiSelect: true,
											noResultsMessage: $elm$core$Maybe$Nothing,
						...
						A3(
						$MadonnaMat$elm_select_two$SelectTwo$Html$select2Dropdown,
						$MadonnaMat$elm_select_two_example$Main$SelectTwo,
						$elm$core$Maybe$Just($MadonnaMat$elm_select_two_example$Main$customHtml),
						model)
					]),
				A3(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Nice modal')
						]),
					$rundis$elm_bootstrap$Bootstrap$Modal$large(
						$rundis$elm_bootstrap$Bootstrap$Modal$config($MadonnaMat$elm_select_two_example$Main$CloseModal))))));
};
var $MadonnaMat$elm_select_two_example$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$MadonnaMat$elm_select_two$SelectTwo$Html$select2Close($MadonnaMat$elm_select_two_example$Main$SelectTwo)
			]),
		_List_fromArray(
			[
				$MadonnaMat$elm_select_two$SelectTwo$Html$select2Css,
				A2(
				$elm$html$Html$h1,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Examples of Elm Select2')
					])),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$rundis$elm_bootstrap$Bootstrap$Button$onClick($MadonnaMat$elm_select_two_example$Main$ShowModal)
									]),
								_List_fromArray(
									[
				...
				$MadonnaMat$elm_select_two_example$Main$viewModal(model)
			]));
};
var $MadonnaMat$elm_select_two_example$Main$topView = function (model) {
	return {
		body: _List_fromArray(
			[
				$MadonnaMat$elm_select_two_example$Main$view(model)
			]),
...
var $MadonnaMat$elm_select_two$SelectTwo$Types$DelayedSelectTwoAjax = function (a) {
	return {$: 'DelayedSelectTwoAjax', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Types$STRes = function (a) {
	return {$: 'STRes', a: a};
};
var $MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoOpen = F2(
	function (a, b) {
		return {$: 'SelectTwoOpen', a: a, b: b};
	});
var $MadonnaMat$elm_select_two$SelectTwo$Types$SentAjax = F3(
	function (a, b, c) {
		return {$: 'SentAjax', a: a, b: b, c: c};
	});
var $MadonnaMat$elm_select_two$SelectTwo$send = function (msg) {
	return A2(
		$elm$core$Task$perform,
		$elm$core$Basics$identity,
		$elm$core$Task$succeed(msg));
};
var $MadonnaMat$elm_select_two$SelectTwo$ajaxCmd = F4(
	function (sender, ajaxParams, reset, model) {
		return A2(
			...
			A2(
				$elm$core$Maybe$map,
				function (id_) {
					return $MadonnaMat$elm_select_two$SelectTwo$send(
						sender(
							A3($MadonnaMat$elm_select_two$SelectTwo$Types$SentAjax, id_, ajaxParams, reset)));
				},
				A2(
					$elm$core$Maybe$andThen,
					function (st) {
						return st.ajax ? $elm$core$Maybe$Just(st.id_) : $elm$core$Maybe$Nothing;
					},
					model.selectTwo)));
	});
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$defaultParams = function (filter) {
	return {loading: true, more: false, page: 1, term: filter};
};
var $MadonnaMat$elm_select_two$SelectTwo$incrementPage = F3(
	function (scrollTop, scrollHeight, params) {
		var scrollPageHeight = scrollHeight / params.page;
		var scrollPageTop = (scrollTop - scrollHeight) + scrollPageHeight;
		return ((scrollPageTop / scrollPageHeight) > 0.7) && ((!params.loading) && params.more);
	});
var $MadonnaMat$elm_select_two$SelectTwo$map = F2(
	function (f, model) {
		var newSelectTwo = A2($elm$core$Maybe$map, f, model.selectTwo);
		return _Utils_update(
			model,
			{selectTwo: newSelectTwo});
	});
var $MadonnaMat$elm_select_two$SelectTwo$sendPageIncrement = F5(
	function (sender, model, scrollTop, scrollHeight, ajaxParams) {
		if (A3($MadonnaMat$elm_select_two$SelectTwo$incrementPage, scrollTop, scrollHeight, ajaxParams)) {
			var newModel = A2(
				$MadonnaMat$elm_select_two$SelectTwo$map,
				function (s) {
					return _Utils_update(
						s,
						{
							ajaxParams: $elm$core$Maybe$Just(
								_Utils_update(
									ajaxParams,
			...
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					newModel,
					A4(
						$MadonnaMat$elm_select_two$SelectTwo$ajaxCmd,
						sender,
						A2(
							$elm$core$Maybe$withDefault,
							$MadonnaMat$elm_select_two$SelectTwo$Private$defaultParams(''),
							A2(
								$elm$core$Maybe$andThen,
								function ($) {
									return $.ajaxParams;
...
var $MadonnaMat$elm_select_two$SelectTwo$checkScrollPage = F4(
	function (scrollTop, scrollHeight, sender, model) {
		return A2(
			...
			A2(
				$elm$core$Maybe$andThen,
				A4($MadonnaMat$elm_select_two$SelectTwo$sendPageIncrement, sender, model, scrollTop, scrollHeight),
				A2(
					$elm$core$Maybe$andThen,
					function ($) {
						return $.ajaxParams;
...
var $MadonnaMat$elm_select_two$SelectTwo$delayedSend = F2(
	function (milli, msg) {
		return A2(
			$elm$core$Task$perform,
			function (_v0) {
			...
			$elm$core$Process$sleep(milli));
	});
var $elm$browser$Browser$Dom$focus = _Browser_call('focus');
var $elm$browser$Browser$Dom$getElement = _Browser_getElement;
var $MadonnaMat$elm_select_two$SelectTwo$new = F2(
	function (dropdown, model) {
		return _Utils_update(
			model,
			{
				selectTwo: $elm$core$Maybe$Just(
					{
						ajax: dropdown.ajax,
						ajaxParams: $elm$core$Maybe$Just(
							$MadonnaMat$elm_select_two$SelectTwo$Private$defaultParams('')),
...
var $MadonnaMat$elm_select_two$SelectTwo$setSearch = function (filter) {
	var search = (filter === '') ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(filter);
	return $MadonnaMat$elm_select_two$SelectTwo$map(
		function (s) {
			return _Utils_update(
				s,
				{search: search});
...
var $MadonnaMat$elm_select_two$SelectTwo$Private$uncurry3 = F2(
	function (f, _v0) {
		var a = _v0.a;
		var b = _v0.b;
		var c = _v0.c;
...
var $MadonnaMat$elm_select_two$SelectTwo$updateDropdown = F2(
	function (elem, model) {
		var selectTwo = A2(
			$elm$core$Maybe$map,
			function (st) {
				var dropdown = st.dropdown;
				var newDropdown = _Utils_update(
					dropdown,
					{width: elem.element.width, x: elem.element.x, y: elem.element.y + elem.element.height});
				return _Utils_update(
					st,
...
var $MadonnaMat$elm_select_two$SelectTwo$update = F4(
	function (sender, msg, maybeAjax, model) {
		switch (msg.$) {
			case 'SelectTwoTrigger':
				var dd = msg.a;
				var newModel = A2($MadonnaMat$elm_select_two$SelectTwo$new, dd, model);
				return _Utils_Tuple2(
					newModel,
					A2(
						...
						A2(
							$elm$core$Basics$composeR,
							$MadonnaMat$elm_select_two$SelectTwo$Types$SelectTwoOpen(dd),
							sender),
						$elm$browser$Browser$Dom$getElement(dd.id_)));
			case 'SelectTwoOpen':
				if (msg.b.$ === 'Ok') {
					var dd = msg.a;
					var elem = msg.b.a;
					var newModel = A2($MadonnaMat$elm_select_two$SelectTwo$updateDropdown, elem, model);
					return _Utils_Tuple2(
						newModel,
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2(
									$elm$core$Task$attempt,
									A2($elm$core$Basics$composeR, $MadonnaMat$elm_select_two$SelectTwo$Types$STRes, sender),
									$elm$browser$Browser$Dom$focus(dd.id_ + '--search')),
									A4(
									$MadonnaMat$elm_select_two$SelectTwo$ajaxCmd,
									sender,
									A2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{selectTwo: $elm$core$Maybe$Nothing}),
						$elm$core$Platform$Cmd$none);
				}
			...
			case 'SelectTwoSelected':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Maybe$withDefault,
						$elm$core$Platform$Cmd$none,
						A2($elm$core$Maybe$map, $MadonnaMat$elm_select_two$SelectTwo$send, mg)));
			case 'SetSelectTwoSearch':
				var filter = msg.a;
				return _Utils_Tuple2(
					A2($MadonnaMat$elm_select_two$SelectTwo$setSearch, filter, model),
					A2(
						$elm$core$Maybe$withDefault,
						$elm$core$Platform$Cmd$none,
						A2(
							...
							function (dd) {
								return $elm$core$Maybe$Just(
									A2(
										$MadonnaMat$elm_select_two$SelectTwo$delayedSend,
										dd.delay,
										sender(
											$MadonnaMat$elm_select_two$SelectTwo$Types$DelayedSelectTwoAjax(filter))));
							},
							A2(
								$elm$core$Maybe$map,
								function ($) {
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						A2(
							$elm$core$Maybe$andThen,
							function (search) {
								return _Utils_eq(search, filter) ? $elm$core$Maybe$Just(
									A4(
										$MadonnaMat$elm_select_two$SelectTwo$ajaxCmd,
										sender,
										$MadonnaMat$elm_select_two$SelectTwo$Private$defaultParams(filter),
										true,
										A2(
											$MadonnaMat$elm_select_two$SelectTwo$map,
											function (s) {
							...
							A2(
								...
								A2(
									...
									model.selectTwo)))));
			case 'ResultScroll':
				var scrollHeight = msg.a.scrollHeight;
				var scrollTop = msg.a.scrollTop;
				return A4($MadonnaMat$elm_select_two$SelectTwo$checkScrollPage, scrollTop, scrollHeight, sender, model);
			case 'STMsg':
				var mg = msg.a;
				return _Utils_Tuple2(
					model,
					$MadonnaMat$elm_select_two$SelectTwo$send(mg));
			case 'STRes':
				var a = msg.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'STNull':
			...
			default:
				...
				return A2(
					...
					A2(
						...
						function (a) {
							return A2(
								$MadonnaMat$elm_select_two$SelectTwo$Private$uncurry3,
								a,
								_Utils_Tuple3(id_, params, reset));
						},
						maybeAjax));
		}
	});
var $MadonnaMat$elm_select_two_example$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SelectTwo':
				var stmsg = msg.a;
				var ajaxCases = $elm$core$Maybe$Just(
					F3(
						function (id_, params, reset) {
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
						}));
				return A4($MadonnaMat$elm_select_two$SelectTwo$update, $MadonnaMat$elm_select_two_example$Main$SelectTwo, stmsg, ajaxCases, model);
			case 'Test3':
				var s = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							test3: A2($elm$core$List$cons, s, model.test3)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Test3Clear':
				if ((msg.a.$ === 'Just') && (msg.a.a.$ === 'Test3')) {
					var s = msg.a.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
...
var $MadonnaMat$elm_select_two_example$Main$main = $elm$browser$Browser$document(
	{init: $MadonnaMat$elm_select_two_example$Main$init, subscriptions: $MadonnaMat$elm_select_two_example$Main$subscriptions, update: $MadonnaMat$elm_select_two_example$Main$update, view: $MadonnaMat$elm_select_two_example$Main$topView});
_Platform_export({'Main':{'init':$MadonnaMat$elm_select_two_example$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"SelectTwo.Types.AjaxParams":{"args":[],"type":"{ page : Basics.Int, term : String.String, more : Basics.Bool, loading : Basics.Bool }"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"SelectTwo.Types.GroupSelectTwoOption":{"args":["msg"],"type":"( String.String, List.List (SelectTwo.Types.SelectTwoOption msg) )"},"SelectTwo.Types.ScrollInfo":{"args":[],"type":"{ scrollHeight : Basics.Int, scrollTop : Basics.Int }"},"SelectTwo.Types.SelectTwoDropdown":{"args":["msg"],"type":"{ id_ : String.String, defaults : List.List (SelectTwo.Types.SelectTwoOption msg), list : List.List (SelectTwo.Types.GroupSelectTwoOption msg), showSearch : Basics.Bool, x : Basics.Float, y : Basics.Float, width : Basics.Float, ajax : Basics.Bool, delay : Basics.Float, noResultsMessage : Maybe.Maybe String.String }"},"SelectTwo.Types.SelectTwoOption":{"args":["msg"],"type":"( Maybe.Maybe msg, String.String, Basics.Bool )"}},"unions":{"Main.Msg":{"args":[],"tags":{"Test3":["Maybe.Maybe String.String"],"SelectTwo":["SelectTwo.Types.SelectTwoMsg Main.Msg"],"Test3Clear":["Maybe.Maybe Main.Msg"],"ShowModal":[],"CloseModal":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"SelectTwo.Types.SelectTwoMsg":{"args":["msg"],"tags":{"SelectTwoTrigger":["SelectTwo.Types.SelectTwoDropdown msg"],"SelectTwoOpen":["SelectTwo.Types.SelectTwoDropdown msg","Result.Result Browser.Dom.Error Browser.Dom.Element"],"SelectTwoHovered":["Maybe.Maybe msg"],"SelectTwoSelected":["Maybe.Maybe msg"],"SetSelectTwoSearch":["String.String"],"DelayedSelectTwoAjax":["String.String"],"STRes":["Result.Result Browser.Dom.Error ()"],"STMsg":["msg"],"STNull":[],"SentAjax":["String.String","SelectTwo.Types.AjaxParams","Basics.Bool"],"ResultScroll":["SelectTwo.Types.ScrollInfo"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));